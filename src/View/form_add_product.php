    ...
    <header>
        <nav class="bg-blue-400">
            <ul class="flex">
                ...
                <li>
                    <a href="src/View/form_add_product.php">Loja de varejo - Cadastro de produtos</a>
                </li>
            </ul>
        </nav>
    </header>
    <main>
        <form action="../Controller/Product.php"
        method="POST">
            <section class="columns-3 m-4">
                ...
                <section class="columns-2">
                    ...
                    <article>
                        <label for="quantity"
                        class="cursor-pointer">Quantidade adquirida</label>
                        <input type="number" name="quantity" id="quantity" class="border border-blue-400">
                    </article>
            </section>
            <article class="flex justify-center mt-4">
                <button type="submit" class="p-4 rounded 
                text-white bg-blue-700">Cadastrar</button>
            </article>
        </form>
    </main>
</body>
